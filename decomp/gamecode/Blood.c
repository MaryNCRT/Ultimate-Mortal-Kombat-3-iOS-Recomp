...
extern void **GameObjects;              /* pointer slot -> 0x0014dfec */
...
extern long  *FatalityMessage;          /* pointer slot -> 0x0014fb30 */
extern long  *AnimalityMessage;         /* pointer slot -> 0x0014fb2c */
