...
**En torno al 26% del esfuerzo total estimado. Todavía no hay nada jugable.**

La barra se mueve por primera vez en un buen rato, y solo porque `lime/common` se movió: 33 funciones de 109 frente a 21 hace poco. El trabajo de formatos que vino antes —resolverlos, renderizarlos y animarlos— valió muchísimo y **no vale ni un punto porcentual**, porque esa fila ya estaba al 100%. Lo que cambió ahí es que ahora está *demostrada* en vez de afirmada.
...
| `lime/common` — núcleo del motor (109 fn) | 12% | 30% | `███░░░░░░░` |
