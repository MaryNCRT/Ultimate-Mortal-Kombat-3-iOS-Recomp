...
Las 109 funciones han sido leídas y documentadas. **99 tienen cuerpo**; las otras
**10 son declaraciones documentadas** — la función está descrita a partir de su
...
| | nº |
|---|---:|
| Con cuerpo escrito | 99 |
| Documentada, cuerpo deliberadamente no escrito | 10 |
| Sin examinar | **0** |
...
| `lime/common` — núcleo del motor (109 fn) | 12% | 91% | `████████░░` |
